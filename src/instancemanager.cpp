...
static QList<ExportFileEntry> collectExportFiles(const QString& gameDataPath, const QString& basePath,
                                                  qint64& totalSize) {
...
static size_t fileReadCallback(void *pOpaque, mz_uint64 file_ofs, void *pBuf, size_t n) {
...
static bool addExportFilesToZip(mz_zip_archive& zip, const QString& basePath,
...
static bool addDirectoryToZip(mz_zip_archive& zip, const QString& basePath, const QString& dirPath,
                               qint64 totalSize, qint64& processedSize,
                               std::function<void(int progress)>& progressCallback) {
    QDir dir(dirPath);
    QFileInfoList entries = dir.entryInfoList(QDir::Files | QDir::Dirs | QDir::NoDotAndDotDot);
